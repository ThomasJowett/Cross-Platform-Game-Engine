...
static GLenum TextureFormatToWebGPUTextureFormat(FrameBufferTextureFormat format)
{
	switch (format)
	{
...
uint32_t WebGPUFrameBuffer::GetColourAttachment(size_t index)
{
...
void WebGPUFrameBuffer::ClearAttachment(size_t index, int value)
{
	...
	GLenum textureFormat = TextureFormatToWebGPUTextureFormat(spec.textureFormat);
